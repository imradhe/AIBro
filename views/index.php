  ...
  <div class="container">
    <div class="mt-5 logo text-center">
      <a href="<?php echo home() ?>"><span class="logo" style="font-size:160px"><img
            src="<?php assets('img/AIBro.png'); ?>" alt="AI Bro Logo" class="img-fluid my-2 mt-5"
            style="max-height: 160px;" /> </span> </a>
      <h1 class="fs-4">
    ...
    <div class="footer position-fixed navbar-fixed shadow-sm bottom-0 bg-white">
      ...
      <button type="button" aria-label="Clear Conversations"
        class="btn btn-clear btn-outline-dark btn-sm rounded-pill mt-2 mb-4 mx-2 fs-6" id="clear">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="announcementTitle"><img src="<?php assets("img/AIBroLogo.png") ?>" alt="AI Bro"
